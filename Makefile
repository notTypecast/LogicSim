...
main: main.cpp bin/component.o bin/gates.o bin/inputs.o bin/outputs.o bin/simulator.o
	$(CC) $(CFLAGS) -o bin/main main.cpp bin/component.o bin/gates.o bin/inputs.o bin/outputs.o bin/simulator.o
