...
{
    return is_input ? comp_io_rel_pos.at(comp_type).first
                    : comp_io_rel_pos.at(comp_type).second;
}
                                                    ...
                                                    bool is_input, int idx)
{
    if (is_input)
    {
        return {
            static_cast<int>(
              comp_io_rel_pos.at(component->comp_type()).first[idx].first *
              component->width()),
            static_cast<int>(
              comp_io_rel_pos.at(component->comp_type()).first[idx].second *
              component->height())
        };
    }
    else
    {
        return {
            static_cast<int>(
              comp_io_rel_pos.at(component->comp_type()).second[idx].first *
              component->width()),
            static_cast<int>(
              comp_io_rel_pos.at(component->comp_type()).second[idx].second *
              component->height())
        };
    }
}
...
QPixmap getComponentResource(COMPONENT comp_type, int res_idx, double scale)
{
    ...
    return res.scaled(static_cast<int>(scale * res.width()),
                      static_cast<int>(scale * res.height()));
}
...
QPixmap getWireMarking(LINE_TYPE line_type, int size, double scale, bool dir_ul)
{
    ...
    default:
    {
        ...
        return pixmap->scaled(size,
                              static_cast<int>(scale * WIRE_MARKING_THICKNESS),
    ...
    case VERTICAL:
    {
        ...
        return pixmap->scaled(static_cast<int>(scale * WIRE_MARKING_THICKNESS),
                              size,
                              Qt::IgnoreAspectRatio,
                              Qt::SmoothTransformation);
    }
...
void load()
{
    ...
    comp_images = {
        ...
        {   COMPONENT::CONSTANT,
         { QPixmap(IMG_PATH + "CONSTANT0.png"),
         QPixmap(IMG_PATH + "CONSTANT1.png") }                           },
        {     COMPONENT::BUTTON,
         { QPixmap(IMG_PATH + "BUTTON0.png"),
         QPixmap(IMG_PATH + "BUTTON1.png") }                             },
        {     COMPONENT::SWITCH,
         { QPixmap(IMG_PATH + "SWITCH0.png"),
         QPixmap(IMG_PATH + "SWITCH1.png") }                             },
        { COMPONENT::OSCILLATOR, { QPixmap(IMG_PATH + "OSCILLATOR.png") } },
        {        COMPONENT::LED,
         { QPixmap(IMG_PATH + "LED0.png"),
         QPixmap(IMG_PATH + "LED1.png"),
         QPixmap(IMG_PATH + "LED2.png") }                                },
        {     COMPONENT::RANDOM,     { QPixmap(IMG_PATH + "RANDOM.png") } },
    ...
    for (int i = 1; i < 33; ++i)
    {
        comp_images[COMPONENT::_7SEG_5IN][i] = QPixmap(
          IMG_PATH + "7SEG5IN_" +
          QString::fromStdString(std::bitset<5>(i - 1).to_string()) + ".png");
    }
    ...
    for (int i = 1; i < 256; ++i)
    {
        comp_images[COMPONENT::_7SEG_8IN][i] = QPixmap(
          IMG_PATH + "7SEG8IN_" +
          QString::fromStdString(std::bitset<8>(i).to_string()) + ".png");
    }
    ...
    for (int i = 1; i < 17; ++i)
    {
        ...
        comp_images[COMPONENT::KEYPAD][i] =
          QPixmap(IMG_PATH + QString::fromStdString(ss.str()));
    }
    ...
    comp_icons = {
        ...
        {   COMPONENT::CONSTANT,
         { new QIcon(IMG_PATH + "CONSTANT0.png"),
         new QIcon(IMG_PATH + "CONSTANT1.png") }                           },
        ...
        {     COMPONENT::RANDOM,     { new QIcon(IMG_PATH + "RANDOM.png") } },
