...
{
  public:
    DeleteComponentsCommand(DesignArea                    *design_area,
                            std::vector<ComponentLabel *> &deleted_components);
...
{
  public:
    MoveComponentsCommand(DesignArea                    *_design_area,
                          std::vector<ComponentLabel *> &moved_components,
                          std::vector<QPoint>            init_positions,
                          std::vector<QPoint>            final_positions);
...
{
  public:
    ChangeComponentPropertyCommand(ComponentLabel *component,
                                   int prev_res_idx = -1, int _res_idx = -1);
...
{
  public:
    ChangeSimulationPropertiesCommand(DesignArea *design_area, int prev_freq,
                                      int freq);
